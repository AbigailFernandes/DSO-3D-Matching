...
public:
	...
	virtual void publishKeyframes( std::vector<FrameHessian*> &frames, bool final, CalibHessian* HCalib) override
	    ...
	    std::ofstream output_points;
            // This is the output ply file for marginalized 3d points.
	    output_points.open("/home/odroid/points.ply", std::ios_base::app);
       
            for (FrameHessian* f : frames)
            {
		printf("HERE :) OUT: KF %d (%s) (id %d, tme %f): %d active, %d marginalized, %d immature points. CameraToWorld:\n",
                       f->frameID,
		...
		std::cout << "Length of pointHessiansMarginalized : %d " << points.size() << "\n";
		    ...
		    // std::cout <<"x : " << worldPoint[0] << "y :  " << worldPoint[1] << "z : " << worldPoint[2] << "\n";
                    output_points << worldPoint[0] << " " << worldPoint[1] << " "  << worldPoint[2] << "\n";
                }
                //}
            }
	output_points.close();
